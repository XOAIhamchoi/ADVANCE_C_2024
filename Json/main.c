...
JsonValue  *parse_object(const char** json)
{
    ...
    if (**json == '{') {
        ...
        object_value->value.object.key = NULL;
            ...
            if(key){
                ...
                if(**json == ':') {
                    ...
                    if(value)
                    {
                        ...
                        object_value->value.object.key = (char **)realloc(object_value->value.object.key,object_value->value.object.count * sizeof(char*));
                        object_value->value.object.key[object_value->value.object.count-1]= key->value.string;
    ...
    switch (json_value->type) {
        ...
        case JSON_OBJECT:
            for (size_t i = 0; i < json_value->value.object.count; i++) {
                free(json_value->value.object.key[i]);
                free_json_value(&json_value->value.object.values[i]);
            }
            free(json_value->value.object.key);
...
void test(JsonValue* json_value){
    if (json_value != NULL && json_value->type == JSON_OBJECT) {
        ...
        for (size_t i = 0; i < num_fields; ++i) {
            ...
            char* key = json_value->value.object.key[i];
